...
```{r km_kw, fig.cap='Battery Power(KW) & Travel Range by Makes', include=TRUE}
gg_point_KW_KM
```
...
```{r price_range, fig.cap='Battery Power (KW) by Makes', include=TRUE}
...
<script>
    ...
    */
    ...
    s.src = 'https://timminilab.disqus.com/embed.js';
