...
The 13 brands are BMW, Land Rover, Mercedes-Benz, Isuzu, Jeep, Toyota, Nissan, Volkswagen, Subaru, Mitsubishi, Mazda, Holden and Hyundai. These brands cover the price range up to `$450,000`, and I believe the capacity of data I collected is sufficient for this post. 
...
Interestingly, Isuzu is the 5th highest in this plot. I have never heard and saw any friends using this make, and perhaps the reason is relevant to its model. I will investigate the models in the next post. 

I separate these 13 makes into three pricing groups:
...
- 1: Land Rover rocketed the price in the model year 2020 and 2021 whilst BMW and Benz reduced the price of the 2021 model. It also happens on Volkswagen. Buying a new Land Rover MY20 and MY21 might not be a cautious decision this year.  
- 2: Three makes have many luxury models that cover various segments. BMW luxury models covers the segment from `$150,000` to `$250,000` while the Land Rover covers the segment from `$180,000` to `$350,000`. The price of Mercedes-Benz luxury models includes the BMW and Land Rover luxury segments. 
